...
import { ProducerComponent } from  "./pages/producer"
...
export class MyApp {
  ...
  private rootPage: any = StartComponent;
  ...
  constructor(
    ...
    this.pages = [
      ...
      { title: 'Producer', component: ProducerComponent },
      { title: 'Start', component:StartComponent },
